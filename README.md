...
│   └── routing-controllers/
│
├── scripts/                       # Benchmark scripts (Bun + TypeScript)
│   ├── benchmark.ts               # Main orchestrator
│   ├── cold-start.ts              # Cold start helper
│   ├── monitor.ts                 # RAM/CPU monitoring
│   └── setup.ts                   # Setup script
│
├── results/                       # Generated benchmark data
│   ├── raw/                       # JSON results per run
│   ├── latest.json                # Latest aggregated results
│   └── summary.md                 # Markdown summary
│
├── .github/
│   └── workflows/
│       ├── benchmark.yml          # Runs benchmarks
│       └── update-readme.yml      # Updates this README
│
├── benchmark-config.json          # Framework registry & config
